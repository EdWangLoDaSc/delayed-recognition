...
export const METHOD_CARDS = [
  {
    ...
    formula:
      "B = sum_{t=0..t_peak} (baseline_t - citations_t) / max(1, baseline_t)\nbaseline_t = c_0 + (c_peak - c_0) * t / t_peak",
  ...
  },
  {
    ...
    formula:
      "citations_per_year = counts_by_year[year]\nmissing observed-window years = 0",
